'''
Get inventory, update inventoy

Input:
- Scanned items will be a list (maybe a function that is a list)

Processes:
- Update inventory based on the list received
- Have a dictionary that shows inventory
...
#Input
Order = ["eggs","chicken","soda","soda","soda"]
